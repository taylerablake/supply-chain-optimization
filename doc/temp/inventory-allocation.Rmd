...
```{r,echo=FALSE, error=FALSE, warning=FALSE, message=FALSE, cache=TRUE,fig.cap="Demand is predicted for each of two regions. While distribution center 1 is closest to the center of the blue region, it is possible that it would be most cost efficient for distribution center 2 to fulfill certain orders placed in the blue region."}
