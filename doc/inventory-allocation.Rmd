...
```{r,echo=FALSE, error=FALSE, warning=FALSE, message=FALSE, cache=TRUE,fig.cap="Household locations of possible orders, each of which is categorized as belonging to one of two regions. While a household may lie within region 1, it may be cheaper for distribution center distribution center",fig.align="center",out.width = "190px",out.height="190px"}
